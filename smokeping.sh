...
#timezone() { local timezone="${1:-America/Los_Angeles}"
timezone() { 
    ...
    # Use Docker-Compose TZ setting :)
    
       echo "$TZ" >/etc/timezone
       cp /usr/share/zoneinfo/$TZ /etc/localtime
       
      #also works# cp /usr/share/zoneinfo/America/Los_Angeles /etc/localtime
      #also works# echo "America/Los_Angeles" > /etc/timezone
